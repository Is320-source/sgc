        ...
        <form method="post" action="{{ route('dashboard.search.porter') }}">
            @csrf
                <div class="row">
                     ...
                     <div class="col-md-6">
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#newPorter" data-whatever="@mdo">Novo Porteiro</button>
                     </div>
...
<div class="white-box">
    ...
    <h3 class="box-title m-b-0">Lista de Porteiros</h3>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="newPorterLabel1">Novo Porteiro</h4> </div>
            <div class="modal-body">
...
<div class="modal fade" id="file" tabindex="-1" role="dialog" aria-labelledby="fileLabel1">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="fileLabel1">Exportar Porteiros</h4> </div>
            <div class="modal-body">
